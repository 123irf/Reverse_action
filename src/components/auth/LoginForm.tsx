...
import { LogIn, User, Shield, UserPlus, Package } from 'lucide-react';
        ...
        <form onSubmit={isSignUp ? handleSignUp : handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`flex-1 flex items-center justify-center px-2 sm:px-3 py-2 sm:py-3 rounded-xl border-2 transition-all text-xs sm:text-sm ${
                  formData.role === 'buyer'
          ...
          <div className="text-center">
            <button
              ...
              className="text-orange-600 hover:text-orange-700 font-medium transition-colors text-sm sm:text-base mb-4 block w-full"
            >
            ...
            <div className="pt-4 border-t border-gray-200">
              <a 
                href="/admin-login"
                className="inline-flex items-center text-gray-600 hover:text-orange-600 font-medium text-sm"
              >
